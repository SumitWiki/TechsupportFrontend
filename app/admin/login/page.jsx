...
export default function AdminLogin() {
  ...
  // ── STEP 2: OTP Verification → Cookie set by backend ──
  const handleVerifyOtp = async (e) => {
    ...
    try {
      ...
      // No localStorage needed — redirect to dashboard
    ...
    <div className="min-h-screen flex bg-white">
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12 bg-slate-50/50">
        <div className="w-full max-w-[420px] animate-[fadeUp_0.4s_ease-out_both]">
          ...
          {message && (
            <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 mb-6 flex items-center gap-2.5">
              {Icons.check("w-[18px] h-[18px] text-blue-500 flex-shrink-0")}
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 bg-white border border-slate-300 rounded-xl text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition text-sm shadow-sm text-center tracking-[0.3em] text-lg font-semibold"
                  autoFocus
                />
              </div>
              <p className="mt-2 text-xs text-slate-400">Check your email inbox for the verification code</p>
            </div>
            ...
            <button
              ...
              className="w-full text-sm text-slate-500 hover:text-slate-700 transition py-2"
            >
              &larr; Back to login
            </button>
          </form>
