...
export const PHONE_USA =
  process.env.NEXT_PUBLIC_PHONE_USA || "+17004797819";
export const PHONE_UK =
  process.env.NEXT_PUBLIC_PHONE_UK || "+448001234567";
export const PHONE_CA =
  process.env.NEXT_PUBLIC_PHONE_CA || "+18005559876";
export const PHONE_DISPLAY =
  process.env.NEXT_PUBLIC_PHONE_DISPLAY || "+1-700-479-7819";
